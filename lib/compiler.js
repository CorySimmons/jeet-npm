...
(function() {
  var autoprefixer, exports, fs, stylus;
  ...
  exports = module.exports = function(path) {
    ...
    return stylus(file.toString(), {
      compress: true
    }).set('paths', [path]).render(function(err, css) {
      ...
      if (err) {
        ...
        return fs.writeFile(path + "custom.css", autoprefixer("last 1 version", "> 1%", "ie 8", "ie 7").compile(css), function() {
